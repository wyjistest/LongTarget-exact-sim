  ...
  return simCudaInitialSafeStoreHandoffEnabledRuntime();
	...
	inline bool simCudaValidateEnabledRuntime()
	{
	  ...
	  else
	  {
		...
		inline std::atomic<uint64_t> &simRegionResidencyCachedFrontierNoUpdateStoreRefreshSkipCount()
		{
		  static std::atomic<uint64_t> count(0);
		  return count;
		}
		...
		inline std::atomic<uint64_t> &simRegionSingleRequestNoFilterOutputBufferOverensureSkipCount()
		{
		  static std::atomic<uint64_t> count(0);
		  return count;
		}
			  ...
			  return count;
				...
				inline std::atomic<uint64_t> &simInitialSummaryResultMaterializeNanoseconds()
				{
				  ...
				  return count;
					...
					inline std::atomic<uint64_t> &simInitialSummaryHostCopyElisionBaseCopyReuseCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialSummaryHostCopyElisionRunCountCopySkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}
					...
					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestPrefixSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestInputPackSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestTargetBufferSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestMatrixBufferSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}
					...
					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestRunBaseBufferEnsureSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}
					...
					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestAllCandidateCountBufferEnsureSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestAllCandidateBaseBufferEnsureSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestAllCandidateBaseUploadSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}
					...
					inline std::atomic<uint64_t> &simInitialAllCandidateOutputBufferOverensureSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}
					...
					inline std::atomic<uint64_t> &simInitialProposalOnlineZeroCandidateCountCopySkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}
					...
					inline std::atomic<uint64_t> &simInitialProposalDirectTopKSingleStateSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialHashReduceSingleRequestBaseBufferEnsureSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialHashReduceSingleRequestBaseUploadSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}
					...
					inline std::atomic<uint64_t> &simInitialProposalV3SingleStateSelectorSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}
					...
					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestProposalV3StateBaseUploadSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestProposalV3StateCountUploadSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}

					inline std::atomic<uint64_t> &simInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkipCount()
					{
					  static std::atomic<uint64_t> count(0);
					  return count;
					}
		...
		inline void recordSimRegionResidencyCachedFrontierNoUpdateStoreRefreshSkips(uint64_t skipCount)
		{
		  simRegionResidencyCachedFrontierNoUpdateStoreRefreshSkipCount().fetch_add(
		    skipCount,
		    std::memory_order_relaxed);
		}
		...
		inline void recordSimRegionSingleRequestDirectReduce(const SimScanCudaBatchResult &batchResult)
		{
		  ...
		  simRegionSingleRequestDirectReduceZeroCandidateCompactBufferEnsureSkipCount().fetch_add(
		    ...
		    std::memory_order_relaxed);
		  simRegionSingleRequestNoFilterOutputBufferOverensureSkipCount().fetch_add(
				                                                  ...
				                                                  uint64_t eventCountCopySkips)
				{
				  ...
				  simInitialSummaryResultMaterializeNanoseconds().fetch_add(resultMaterializeNanoseconds,
					  ...
					  simInitialSummaryHostCopyElisionCountCopyReuseCount().fetch_add(countCopyReuses,
					                                                                  std::memory_order_relaxed);
					  simInitialSummaryHostCopyElisionBaseCopyReuseCount().fetch_add(baseCopyReuses,
					                                                                 std::memory_order_relaxed);
					...
					inline void recordSimInitialTrueBatchSingleRequestPrefixSkips(uint64_t prefixSkips)
					{
					  simInitialTrueBatchSingleRequestPrefixSkipCount().fetch_add(prefixSkips,
					                                                              std::memory_order_relaxed);
					}

					inline void recordSimInitialTrueBatchSingleRequestInputPackSkips(uint64_t inputPackSkips)
					{
					  simInitialTrueBatchSingleRequestInputPackSkipCount().fetch_add(inputPackSkips,
					                                                                 std::memory_order_relaxed);
					}

					inline void recordSimInitialTrueBatchSingleRequestTargetBufferSkips(uint64_t targetBufferSkips)
					{
					  simInitialTrueBatchSingleRequestTargetBufferSkipCount().fetch_add(targetBufferSkips,
					                                                                   std::memory_order_relaxed);
					}

					inline void recordSimInitialTrueBatchSingleRequestMatrixBufferSkips(uint64_t matrixBufferSkips)
					{
					  simInitialTrueBatchSingleRequestMatrixBufferSkipCount().fetch_add(matrixBufferSkips,
					                                                                   std::memory_order_relaxed);
					}
					...
					inline void recordSimInitialTrueBatchSingleRequestRunBaseBufferEnsureSkips(uint64_t runBaseBufferEnsureSkips)
					{
					  simInitialTrueBatchSingleRequestRunBaseBufferEnsureSkipCount().fetch_add(runBaseBufferEnsureSkips,
					                                                                           std::memory_order_relaxed);
					}
					...
					inline void recordSimInitialTrueBatchSingleRequestAllCandidateCountBufferEnsureSkips(
					  uint64_t allCandidateCountBufferEnsureSkips)
					{
					  simInitialTrueBatchSingleRequestAllCandidateCountBufferEnsureSkipCount().fetch_add(
					    allCandidateCountBufferEnsureSkips,
					    std::memory_order_relaxed);
					}

					inline void recordSimInitialTrueBatchSingleRequestAllCandidateBaseBufferEnsureSkips(
					  uint64_t allCandidateBaseBufferEnsureSkips)
					{
					  simInitialTrueBatchSingleRequestAllCandidateBaseBufferEnsureSkipCount().fetch_add(
					    allCandidateBaseBufferEnsureSkips,
					    std::memory_order_relaxed);
					}

					inline void recordSimInitialTrueBatchSingleRequestAllCandidateBaseUploadSkips(
					  uint64_t allCandidateBaseUploadSkips)
					{
					  simInitialTrueBatchSingleRequestAllCandidateBaseUploadSkipCount().fetch_add(
					...
					inline void recordSimInitialAllCandidateOutputBufferOverensureSkips(
					  uint64_t outputBufferOverensureSkips)
					{
					  simInitialAllCandidateOutputBufferOverensureSkipCount().fetch_add(
					...
					inline void recordSimInitialProposalOnlineZeroCandidateCountCopySkips(
					  uint64_t countCopySkips)
					{
					  simInitialProposalOnlineZeroCandidateCountCopySkipCount().fetch_add(
					    countCopySkips,
					    std::memory_order_relaxed);
					}
					...
					inline void recordSimInitialProposalDirectTopKSingleStateSkips(uint64_t singleStateSkips)
					{
					  simInitialProposalDirectTopKSingleStateSkipCount().fetch_add(singleStateSkips,
					                                                               std::memory_order_relaxed);
					}

					inline void recordSimInitialHashReduceSingleRequestBaseBufferEnsureSkips(
					  uint64_t baseBufferEnsureSkips)
					{
					  simInitialHashReduceSingleRequestBaseBufferEnsureSkipCount().fetch_add(
					    baseBufferEnsureSkips,
					    std::memory_order_relaxed);
					}

					inline void recordSimInitialHashReduceSingleRequestBaseUploadSkips(uint64_t baseUploadSkips)
					{
					  simInitialHashReduceSingleRequestBaseUploadSkipCount().fetch_add(baseUploadSkips,
					                                                                  std::memory_order_relaxed);
					}
					...
					inline void recordSimInitialProposalV3SingleStateSelectorSkips(uint64_t singleStateSelectorSkips)
					{
					  simInitialProposalV3SingleStateSelectorSkipCount().fetch_add(singleStateSelectorSkips,
					                                                               std::memory_order_relaxed);
					}
					...
					inline void recordSimInitialTrueBatchSingleRequestProposalV3StateBaseUploadSkips(uint64_t stateBaseUploadSkips)
					{
					  simInitialTrueBatchSingleRequestProposalV3StateBaseUploadSkipCount().fetch_add(stateBaseUploadSkips,
					                                                                               std::memory_order_relaxed);
					}

					inline void recordSimInitialTrueBatchSingleRequestProposalV3StateCountUploadSkips(uint64_t stateCountUploadSkips)
					{
					  simInitialTrueBatchSingleRequestProposalV3StateCountUploadSkipCount().fetch_add(stateCountUploadSkips,
					                                                                                std::memory_order_relaxed);
					}

					inline void recordSimInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkips(uint64_t selectedBufferEnsureSkips)
					{
					  simInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkipCount().fetch_add(selectedBufferEnsureSkips,
					                                                                                    std::memory_order_relaxed);
					}
		...
		inline void getSimRegionReductionStats(uint64_t &eventCount,
		                                      ...
		                                      uint64_t &residencyCachedFrontierNoUpdateStoreRefreshSkips)
		{
		  ...
		  residencyCachedFrontierNoUpdateStoreRefreshSkips =
		    simRegionResidencyCachedFrontierNoUpdateStoreRefreshSkipCount().load(std::memory_order_relaxed);
		}
		...
		inline void getSimRegionSingleRequestDirectReduceStats(uint64_t &attempts,
		                                                       ...
		                                                       uint64_t &noFilterOutputBufferOverensureSkips,
		                                                       ...
		                                                       uint64_t &reduceWorkItems)
		{
		  ...
		  zeroCandidateCompactBufferEnsureSkips =
		    simRegionSingleRequestDirectReduceZeroCandidateCompactBufferEnsureSkipCount().load(
		      std::memory_order_relaxed);
		  noFilterOutputBufferOverensureSkips =
		    simRegionSingleRequestNoFilterOutputBufferOverensureSkipCount().load(std::memory_order_relaxed);
			  ...
			  packSeconds =
					                                                    ...
					                                                    uint64_t &eventCountCopySkips)
				{
				  ...
				  eventCountCopySkips =
					...
					inline void getSimInitialTrueBatchSingleRequestPrefixStats(uint64_t &prefixSkips)
					{
					  prefixSkips =
					    simInitialTrueBatchSingleRequestPrefixSkipCount().load(std::memory_order_relaxed);
					}

					inline void getSimInitialTrueBatchSingleRequestInputPackStats(uint64_t &inputPackSkips)
					{
					  inputPackSkips =
					    simInitialTrueBatchSingleRequestInputPackSkipCount().load(std::memory_order_relaxed);
					}

					inline void getSimInitialTrueBatchSingleRequestTargetBufferStats(uint64_t &targetBufferSkips)
					{
					  targetBufferSkips =
					    simInitialTrueBatchSingleRequestTargetBufferSkipCount().load(std::memory_order_relaxed);
					}

					inline void getSimInitialTrueBatchSingleRequestMatrixBufferStats(uint64_t &matrixBufferSkips)
					{
					  matrixBufferSkips =
					...
					{
					  metadataBufferSkips =
					    simInitialTrueBatchSingleRequestMetadataBufferSkipCount().load(std::memory_order_relaxed);
					}
					...
					inline void getSimInitialTrueBatchSingleRequestRunBaseBufferEnsureStats(uint64_t &runBaseBufferEnsureSkips)
					{
					  runBaseBufferEnsureSkips =
					    simInitialTrueBatchSingleRequestRunBaseBufferEnsureSkipCount().load(std::memory_order_relaxed);
					}
					...
					inline void getSimInitialTrueBatchSingleRequestAllCandidateCountBufferEnsureStats(
					  uint64_t &allCandidateCountBufferEnsureSkips)
					{
					  allCandidateCountBufferEnsureSkips =
					    simInitialTrueBatchSingleRequestAllCandidateCountBufferEnsureSkipCount().load(
					      std::memory_order_relaxed);
					}

					inline void getSimInitialTrueBatchSingleRequestAllCandidateBaseBufferEnsureStats(
					  uint64_t &allCandidateBaseBufferEnsureSkips)
					{
					  allCandidateBaseBufferEnsureSkips =
					    simInitialTrueBatchSingleRequestAllCandidateBaseBufferEnsureSkipCount().load(
					      std::memory_order_relaxed);
					}

					inline void getSimInitialTrueBatchSingleRequestAllCandidateBaseUploadStats(
					  uint64_t &allCandidateBaseUploadSkips)
					{
					  allCandidateBaseUploadSkips =
					...
					inline void getSimInitialAllCandidateOutputBufferOverensureStats(
					  uint64_t &outputBufferOverensureSkips)
					{
					  outputBufferOverensureSkips =
					...
					inline void getSimInitialProposalOnlineZeroCandidateCountCopyStats(
					  uint64_t &countCopySkips)
					{
					  countCopySkips =
					    simInitialProposalOnlineZeroCandidateCountCopySkipCount().load(
					      std::memory_order_relaxed);
					}
					...
					inline void getSimInitialProposalDirectTopKSingleStateStats(uint64_t &singleStateSkips)
					{
					  singleStateSkips =
					    simInitialProposalDirectTopKSingleStateSkipCount().load(std::memory_order_relaxed);
					}

					inline void getSimInitialHashReduceSingleRequestBaseBufferEnsureStats(
					  uint64_t &baseBufferEnsureSkips)
					{
					  baseBufferEnsureSkips =
					    simInitialHashReduceSingleRequestBaseBufferEnsureSkipCount().load(std::memory_order_relaxed);
					}

					inline void getSimInitialHashReduceSingleRequestBaseUploadStats(uint64_t &baseUploadSkips)
					{
					  baseUploadSkips =
					...
					inline void getSimInitialProposalV3SingleStateSelectorStats(uint64_t &singleStateSelectorSkips)
					{
					  singleStateSelectorSkips =
					    simInitialProposalV3SingleStateSelectorSkipCount().load(std::memory_order_relaxed);
					}
					...
					{
					  stateBaseBufferEnsureSkips =
					    simInitialTrueBatchSingleRequestProposalV3StateBaseBufferEnsureSkipCount().load(std::memory_order_relaxed);
					}

					inline void getSimInitialTrueBatchSingleRequestProposalV3StateBaseUploadStats(uint64_t &stateBaseUploadSkips)
					{
					  stateBaseUploadSkips =
					    simInitialTrueBatchSingleRequestProposalV3StateBaseUploadSkipCount().load(std::memory_order_relaxed);
					}

					inline void getSimInitialTrueBatchSingleRequestProposalV3StateCountUploadStats(uint64_t &stateCountUploadSkips)
					{
					  stateCountUploadSkips =
					    simInitialTrueBatchSingleRequestProposalV3StateCountUploadSkipCount().load(std::memory_order_relaxed);
					}

					inline void getSimInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureStats(uint64_t &selectedBufferEnsureSkips)
					{
					  selectedBufferEnsureSkips =
					    simInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkipCount().load(std::memory_order_relaxed);
					}
		            ...
		            cudaBatchResult.initialOrderedSegmentedV3CountClearSkips);
			          recordSimInitialSummaryPackedD2H(
			            ...
			            cudaBatchResult.initialSummaryPackedD2HFallbacks);
				          ...
				          recordSimInitialTrueBatchSingleRequestPrefixSkips(
				          ...
				          recordSimInitialTrueBatchSingleRequestTargetBufferSkips(
				          ...
				          recordSimInitialTrueBatchSingleRequestRunBaseBufferEnsureSkips(
				            cudaBatchResult.initialTrueBatchSingleRequestRunBaseBufferEnsureSkips);
				          ...
				          recordSimInitialTrueBatchSingleRequestAllCandidateCountSkips(
				            cudaBatchResult.initialTrueBatchSingleRequestAllCandidateCountSkips);
				          recordSimInitialTrueBatchSingleRequestAllCandidateCountBufferEnsureSkips(
				            cudaBatchResult.initialTrueBatchSingleRequestAllCandidateCountBufferEnsureSkips);
				          ...
				          recordSimInitialProposalOnlineZeroCandidateCountCopySkips(
				            cudaBatchResult.initialProposalOnlineZeroCandidateCountCopySkips);
				          ...
				          recordSimInitialTrueBatchSingleRequestProposalV3StateBaseUploadSkips(
				            cudaBatchResult.initialTrueBatchSingleRequestProposalV3StateBaseUploadSkips);
				          recordSimInitialTrueBatchSingleRequestProposalV3StateCountUploadSkips(
				            cudaBatchResult.initialTrueBatchSingleRequestProposalV3StateCountUploadSkips);
				          recordSimInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkips(
				            cudaBatchResult.initialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkips);
				          recordSimInitialTrueBatchSingleRequestProposalV3SelectedBaseUploadSkips(
				            cudaBatchResult.initialTrueBatchSingleRequestProposalV3SelectedBaseUploadSkips);
                                            ...
                                            SimSafeWorksetFallbackReason *fallbackReason)
{
  ...
  if(useResidencyMaintenance)
  {
    ...
    if(recordTelemetry)
    {
      ...
      recordSimRegionResidencyCachedFrontierNoUpdateStoreRefreshSkips(
        cudaBatchResult.regionResidencyCachedFrontierNoUpdateStoreRefreshSkips);
