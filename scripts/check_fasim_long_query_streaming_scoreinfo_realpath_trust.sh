...
WORK="${WORK:-"$ROOT/.tmp/check_fasim_long_query_streaming_scoreinfo_realpath_trust"}"
...
grep -q '^benchmark\.fasim_long_query_streaming_scoreinfo_gpu_shadow_realpath_digest_authority=external_digest_gate$' "$stderr"
grep -q '^benchmark\.fasim_long_query_streaming_scoreinfo_gpu_shadow_realpath_trust=1$' "$stderr"
grep -q '^benchmark\.fasim_long_query_streaming_scoreinfo_gpu_shadow_cpu_prealign_seconds=0$' "$stderr"
