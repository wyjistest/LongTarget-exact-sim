...
Chr	QueryStart	QueryEnd	StartInGenome	EndInGenome	Strand	Rule	StartInSeq	EndInSeq	Direction	Score	Nt(bp)	MeanIdentity(%)	MeanStability
chr22	1	20	1000	1020	ParaPlus	1	110	120	+	100	11	90	-12
chr22	21	40	2000	2020	ParaPlus	1	605	620	+	74	16	90	-12
chr22	41	60	3000	3020	ParaPlus	1	705	720	+	67	16	90	-12
chr22	61	80	4000	4020	ParaPlus	1	805	820	+	60	16	90	-12
EOF
...
0	0	1	5000	0	1	ParaPlus	1	0	0	100	140	100	140	100	90	10	3	41	1	1	1	1	1	1	0	kept
1	0	1	5000	0	1	ParaPlus	1	0	0	200	240	200	240	100	90	10	3	41	1	1	1	1	1	1	0	kept
1	0	1	5000	0	1	ParaPlus	1	1		600	630	600	630	73	71	2	1	31	1	0	0	0	0	0	0	low_support_or_margin
2	0	1	5000	0	1	ParaPlus	1	0	0	300	340	300	340	100	90	10	3	41	1	1	1	1	1	1	0	kept
2	0	1	5000	0	1	ParaPlus	1	1		700	730	700	730	67	65	2	1	31	1	0	0	0	0	0	0	low_support_or_margin
3	0	1	5000	0	1	ParaPlus	1	0	0	400	440	400	440	100	90	10	3	41	1	1	1	1	1	1	0	kept
3	0	1	5000	0	1	ParaPlus	1	1		800	830	800	830	60	58	2	1	31	1	0	0	0	0	0	0	low_support_or_margin
EOF
...
dominant = strategies["score_band_lt_75_dominant"]["aggregate"]
assert strategies["score_band_lt_75_dominant"]["resolved_score_band"] == "70_74"
assert dominant["predicted_rescued_task_count"] == 1
assert dominant["predicted_rescued_window_count"] == 1
assert math.isclose(dominant["predicted_top_hit_retention"], 1.0)
assert math.isclose(dominant["predicted_top5_retention"], 0.5)
assert math.isclose(dominant["predicted_top10_retention"], 0.5)
assert math.isclose(dominant["predicted_score_weighted_recall"], 174.0 / 301.0)

band_70_74 = strategies["score_band_70_74"]["aggregate"]
assert band_70_74["predicted_rescued_task_count"] == 1
assert band_70_74["predicted_rescued_window_count"] == 1
assert math.isclose(band_70_74["predicted_top10_retention"], 0.5)
assert math.isclose(band_70_74["predicted_score_weighted_recall"], 174.0 / 301.0)

band_65_69 = strategies["score_band_65_69"]["aggregate"]
assert band_65_69["predicted_rescued_task_count"] == 1
assert band_65_69["predicted_rescued_window_count"] == 1
assert math.isclose(band_65_69["predicted_top10_retention"], 0.5)
assert math.isclose(band_65_69["predicted_score_weighted_recall"], 167.0 / 301.0)

band_lt_65 = strategies["score_band_lt_65"]["aggregate"]
assert band_lt_65["predicted_rescued_task_count"] == 1
assert band_lt_65["predicted_rescued_window_count"] == 1
assert math.isclose(band_lt_65["predicted_top10_retention"], 0.5)
assert math.isclose(band_lt_65["predicted_score_weighted_recall"], 160.0 / 301.0)
PY
