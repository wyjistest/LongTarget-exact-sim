...
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_shadow_enabled=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_requests=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_cells=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_cpu_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_pack_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_h2d_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_kernel_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_d2h_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_unpack_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_total_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_score_mismatches=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_endpoint_mismatches=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_align_forward_score_gpu_unsupported_requests=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_shadow_enabled=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_requests=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_cells=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_pack_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_h2d_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_kernel_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_d2h_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_unpack_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_total_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_cpu_reference_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_score_mismatches=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_endpoint_mismatches=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_forward_score_batch_unsupported_requests=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_shadow_enabled=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_requests=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_cells=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_groups=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_descriptor_count=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_descriptor_bytes=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_query_buffer_bytes=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_target_buffer_bytes=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_pack_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_h2d_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_kernel_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_d2h_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_unpack_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_total_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_cpu_reference_seconds=0(\.0+)?([eE][-+]?[0-9]+)?$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_score_mismatches=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_endpoint_mismatches=0$' "$WORK/on/stderr.log"
grep -Eq '^benchmark\.fasim_score_bridge_unsupported_requests=0$' "$WORK/on/stderr.log"
