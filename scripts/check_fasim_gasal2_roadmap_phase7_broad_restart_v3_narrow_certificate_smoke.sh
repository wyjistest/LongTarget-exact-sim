...
DOC="$ROOT/docs/fasim_gasal2_phase7_broad_restart_v3_narrow_certificate_smoke.md"
DESIGN="$ROOT/docs/fasim_gasal2_phase7_broad_restart_v3_narrow_certificate_design.md"
...
for phrase in required:
    if phrase not in flat:
        raise SystemExit(f"missing required narrow-certificate smoke phrase: {phrase}")
...
for phrase in [
    ...
    if phrase not in design_flat:
        raise SystemExit(f"missing narrow design prerequisite phrase: {phrase}")

for target in [
    "check-fasim-gasal2-phase7-v3-narrow-certificate-env:",
    "check-fasim-gasal2-phase7-v3-narrow-certificate-runtime-smoke:",
    "check-fasim-gasal2-roadmap-phase7-broad-restart-v3-narrow-certificate-smoke:",
]:
...
if claimed_broad:
    raise SystemExit("workload matrix must not claim broad_replacement from narrow-certificate smoke")

print("phase7_broad_restart_v3_narrow_certificate_smoke=bounded_probe_no_go_missing_certificate")
print("phase7_broad_restart_v3_narrow_certificate_status=runtime_smoke_no_go")
print("phase7_broad_restart_v3_gate_v3_1_pass=0")
print("phase7_broad_restart_v3_gate_v3_2_pass=0")
print("phase7_broad_restart_v3_next_gate=real_narrow_certificate_coverage_proof")
