...
WORK="${WORK:-"$ROOT/.tmp/check_fasim_gasal2_phase7_post_v5_3_gpu_consumer_summary_env_runtime_smoke"}"
...
if digest_for_dir(baseline_dir) != digest_for_dir(candidate_dir):
    raise SystemExit("post-v5.3 env scaffold changed lite output digest")
...
require_eq(candidate, "gpu_consumer_summary_rows", "0")
require_eq(candidate, "gpu_consumer_reduces_before_host_transfer", "0")
...
print("phase7_post_v5_3_gpu_consumer_summary_env_runtime_smoke=fail_closed_no_source")
print("phase7_post_v5_3_gpu_consumer_summary_requested=1")
print("phase7_post_v5_3_gpu_consumer_summary_active=0")
