...
grep -Eq '^benchmark\.fasim_sim_recovery_learned_detector_dataset_expansion\.total\.heldout_workload_available=[01]$' "$LOG"
grep -Eq '^benchmark\.fasim_sim_recovery_learned_detector_dataset_expansion\.total\.heldout_family_available=[01]$' "$LOG"
grep -Eq '^benchmark\.fasim_sim_recovery_learned_detector_dataset_expansion\.total\.hard_negative_source_count=[0-9]+$' "$LOG"
grep -Eq '^benchmark\.fasim_sim_recovery_learned_detector_dataset_expansion\.total\.modeling_gate=[A-Za-z0-9_.:-]+$' "$LOG"
