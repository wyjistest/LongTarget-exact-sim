...
This checkpoint records the fork after the native CUDA/Fasim DP engine first1
...
The previous checkpoint established that the native CUDA/Fasim DP shadow was
...
The current native-DP family is stopped:
...
This checkpoint advances the roadmap by recording that the native CUDA/Fasim
DP engine family did not produce consumable certificates. It does not prove a
new design, runtime speedup, or broad replacement.
