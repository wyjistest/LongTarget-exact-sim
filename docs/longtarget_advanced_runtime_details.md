# LongTarget Advanced Runtime Details

This document keeps the detailed runtime notes that used to live in the
repository README. Commands in this file assume they are run from the repository
root. The short entry point is now [README.md](../README.md).
...
# Other codes
The DatabaseScripts subdirectory contains the scripts written in Python and Perl for building LongMan database. The web application of LongMan is available at http://lncrna.smu.edu.cn/show/info .
