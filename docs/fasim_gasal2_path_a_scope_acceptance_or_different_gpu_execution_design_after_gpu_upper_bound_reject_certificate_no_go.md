...
This checkpoint records the fork after the GPU upper-bound reject certificate
...
The previous checkpoint established that the upper-bound reject certificate
...
not prove that any scoreInfo/preAlign group or Align-side attempt can be
skipped before CPU authority runs.

## Stopped Families

The current upper-bound reject certificate family is stopped:
...
This checkpoint advances the roadmap by recording that the GPU upper-bound
reject certificate family did not produce consumable rejected work. It does
not prove a new design, runtime speedup, or broad replacement.
