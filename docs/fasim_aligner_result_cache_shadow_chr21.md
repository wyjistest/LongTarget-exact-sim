...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 142.986000 | 28.535400 | 39.125700 | 5.01x | 6546 | `sha256:81b9c5e23d63534b27f0742d512323ff678bbf648e5ae5e6ea03aab1c4717d26` | yes | yes |

## Request Shape

| Calls | Unique keys | Duplicate calls | Duplicate fraction | Duplicate cells | Memory estimate bytes |
| --- | --- | --- | --- | --- | --- |
| 979,282 | 882,894 | 96,388 | 9.84% | 18,628,647,964 | 232,819,224 |

## Key Class

| Key class | Calls | Unique | Duplicates | Est saved seconds | Mismatch count |
| --- | --- | --- | --- | --- | --- |
| query_hash + target_hash + filter/mask/scoring/AVX2 mode | 979,282 | 882,894 | 96,388 | 2.720290 | 0 |
