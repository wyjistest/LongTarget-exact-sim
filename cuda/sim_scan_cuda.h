...
struct SimScanCudaBatchResult
{
  SimScanCudaBatchResult():
    ...
    regionResidencyCachedFrontierNoUpdateSkips(0),
    regionResidencyCachedFrontierNoUpdateStoreRefreshSkips(0),
    usedCuda(false),
    ...
    regionPackedAggregationNoBlockedMetadataUploadSkips(0),
    ...
    regionPackedAggregationZeroRunTrueBatchEventCountSkips(0),
    regionPackedAggregationZeroRunTrueBatchEventTotalsD2HSkips(0),
    ...
    regionPackedAggregationSingleSummaryRequestReduceSkips(0),
    regionPackedAggregationSingleSummaryFilterKernelFusions(0),
    regionPackedAggregationSingleRequestFinalReduceSkips(0),
    regionPackedAggregationAlreadyPackedFinalCompactSkips(0),
    regionPackedAggregationFinalReduceKeyBufferEnsureSkips(0),
    regionPackedAggregationNoFilterSliceReduceKeyBufferEnsureSkips(0),
    ...
    regionSingleRequestDirectReduceZeroRunEventCountD2HSkips(0),
  ...
  uint64_t regionSingleRequestNoFilterOutputBufferOverensureSkips;
  ...
  uint64_t regionResidencyCachedFrontierNoUpdateSkips;
  uint64_t regionResidencyCachedFrontierNoUpdateStoreRefreshSkips;
  bool usedCuda;
  ...
  uint64_t regionPackedAggregationCandidateBufferHighWaterEnsureSkips;
  ...
  uint64_t regionPackedAggregationNoBlockedMetadataUploadSkips;
  ...
  uint64_t regionPackedAggregationZeroRunTrueBatchEventCountSkips;
  uint64_t regionPackedAggregationZeroRunTrueBatchEventTotalsD2HSkips;
  ...
  uint64_t regionPackedAggregationSingleSummaryRequestReduceSkips;
  uint64_t regionPackedAggregationSingleSummaryFilterKernelFusions;
  uint64_t regionPackedAggregationSingleRequestFinalReduceSkips;
  uint64_t regionPackedAggregationAlreadyPackedFinalCompactSkips;
  uint64_t regionPackedAggregationFinalReduceKeyBufferEnsureSkips;
  uint64_t regionPackedAggregationNoFilterSliceReduceKeyBufferEnsureSkips;
  ...
  uint64_t regionSingleRequestDirectReduceZeroRunEventCountD2HSkips;
