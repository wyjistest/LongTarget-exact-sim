...
- `benchmark.sim_initial_proposal_direct_topk_count_clear_skips`: initial proposal V2 direct-topK telemetry for selector count clears skipped because the selector kernel overwrites the count output
...
- `benchmark.sim_initial_true_batch_single_request_proposal_v3_selected_base_upload_skips`: initial true-batch proposal V3 telemetry for single-request selected-base H2D uploads skipped by compacting selected states with implicit output base 0
