  ...
  uint64_t boundedShadowCalls)
{
  ...
  if(rangeMode == SIM_INITIAL_EXACT_FRONTIER_ONE_CHUNK_BOUNDED_RANGE_REQUEST &&
     boundedShadowCalls == 0)
  {
    return "request_index_not_found";
  }
  return boundedShadowCalls > 0 ? "none" : "missing_ordered_summary_stream";
}

static inline const char *longtargetSimInitialExactFrontierOneChunkBoundedShadowCapDisabledReason()
{
  if(!simCudaInitialExactFrontierOneChunkBoundedShadowRequestedRuntime())
  {
    return "env_off";
  ...
  if(!simCudaInitialExactFrontierOneChunkBoundedShadowCapClampedRuntime())
  {
    return "none";
  }
...
static inline string longtargetSimInitialExactFrontierOneChunkBoundedShadowRequestIndex()
{
  const uint64_t requestIndex =
    simCudaInitialExactFrontierOneChunkBoundedShadowRequestIndexRuntime();
  if(requestIndex == numeric_limits<uint64_t>::max())
  {
    return "all";
  }
  ostringstream out;
...
static inline void printLongTargetBenchmarkMetrics(const LongTargetExecutionMetrics &metrics)
{
  ...
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_erase_scan_lookup_seconds="
      <<(static_cast<double>(simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_ERASE_SCAN_LOOKUP_NANOSECONDS)) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_erase_compact_seconds="
      <<(static_cast<double>(simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_ERASE_COMPACT_NANOSECONDS)) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_erase_index_rebuild_seconds="
      <<(static_cast<double>(simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_ERASE_INDEX_REBUILD_NANOSECONDS)) / 1.0e9)<<endl;
  ...
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_prune_scan_seconds="
      <<(static_cast<double>(simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_PRUNE_SCAN_NANOSECONDS)) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_prune_compact_seconds="
      <<(static_cast<double>(simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_PRUNE_COMPACT_NANOSECONDS)) / 1.0e9)<<endl;
  ...
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_erase_scanned_states="
      <<simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_ERASE_SCANNED_STATE_COUNT)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_erased_states="
      <<simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_ERASED_STATE_COUNT)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_erase_index_entries_before="
      <<simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_ERASE_INDEX_ENTRIES_BEFORE_COUNT)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_erase_index_entries_after="
      <<simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_ERASE_INDEX_ENTRIES_AFTER_COUNT)<<endl;
  ...
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_prune_index_entries_before="
      <<simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_PRUNE_INDEX_ENTRIES_BEFORE_COUNT)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_prune_index_entries_after="
      <<simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_PRUNE_INDEX_ENTRIES_AFTER_COUNT)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_tombstone_est_mark_ops="
      <<simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_TOMBSTONE_EST_MARK_OP_COUNT)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_tombstone_est_erase_scan_states_saved="
      <<simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_TOMBSTONE_EST_ERASE_SCAN_STATES_SAVED_COUNT)<<endl;
  cerr<<"benchmark.sim_safe_workset_merge_safe_store_tombstone_est_erase_index_entries_saved="
      <<simSafeWorksetMergeBreakdown.get(SIM_SAFE_WORKSET_MERGE_SAFE_STORE_TOMBSTONE_EST_ERASE_INDEX_ENTRIES_SAVED_COUNT)<<endl;
  ...
  cerr<<"benchmark.sim_safe_store_merge_shadow_est_tombstone_mark_ops="
      <<simSafeStoreMergeStructureShadow.estTombstoneMarkOps<<endl;
  cerr<<"benchmark.sim_safe_store_merge_shadow_est_tombstone_erase_scan_states_saved="
      <<simSafeStoreMergeStructureShadow.estTombstoneEraseScanStatesSaved<<endl;
  cerr<<"benchmark.sim_safe_store_merge_shadow_est_tombstone_erase_index_entries_saved="
      <<simSafeStoreMergeStructureShadow.estTombstoneEraseIndexEntriesSaved<<endl;
  ...
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_enabled="
      <<(simSafeWorksetDeferredIndexShadowEnabledRuntime() ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_calls="
      <<simSafeWorksetDeferredIndexShadow.calls<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_seconds="
      <<(static_cast<double>(simSafeWorksetDeferredIndexShadow.nanoseconds) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_input_states="
      <<simSafeWorksetDeferredIndexShadow.inputStates<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_returned_states="
      <<simSafeWorksetDeferredIndexShadow.returnedStates<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_affected_start_keys="
      <<simSafeWorksetDeferredIndexShadow.affectedStartKeys<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_legacy_index_rebuilds="
      <<simSafeWorksetDeferredIndexShadow.legacyIndexRebuilds<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_shadow_index_rebuilds="
      <<simSafeWorksetDeferredIndexShadow.shadowIndexRebuilds<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_est_index_rebuilds_saved="
      <<simSafeWorksetDeferredIndexShadow.estIndexRebuildsSaved<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_index_rebuild_seconds="
      <<(static_cast<double>(simSafeWorksetDeferredIndexShadow.shadowIndexRebuildNanoseconds) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_est_seconds_saved="
      <<(static_cast<double>(simSafeWorksetDeferredIndexShadow.estSecondsSavedNanoseconds) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_kept_states="
      <<simSafeWorksetDeferredIndexShadow.keptStates<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_removed_states="
      <<simSafeWorksetDeferredIndexShadow.removedStates<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_index_entries="
      <<simSafeWorksetDeferredIndexShadow.indexEntries<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_size_mismatches="
      <<simSafeWorksetDeferredIndexShadow.sizeMismatches<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_candidate_mismatches="
      <<simSafeWorksetDeferredIndexShadow.candidateMismatches<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_order_mismatches="
      <<simSafeWorksetDeferredIndexShadow.orderMismatches<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_digest_mismatches="
      <<simSafeWorksetDeferredIndexShadow.digestMismatches<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_index_entry_mismatches="
      <<simSafeWorksetDeferredIndexShadow.indexEntryMismatches<<endl;
  cerr<<"benchmark.sim_safe_workset_deferred_index_shadow_kept_count_mismatches="
  ...
  SimInitialSafeStoreGpuPrecombinePruneShadowStats simInitialSafeStoreGpuPrecombinePruneShadowStats;
  SimInitialSafeStoreGpuPrecombinePruneStats simInitialSafeStoreGpuPrecombinePruneStats;
  ...
  uint64_t simInitialExactFrontierOneChunkBoundedShadowRangeStartMin = 0;
  uint64_t simInitialExactFrontierOneChunkBoundedShadowRangeStartMax = 0;
  uint64_t simInitialExactFrontierOneChunkBoundedShadowRangeLengthMax = 0;
  uint64_t simInitialExactFrontierOneChunkBoundedShadowStandaloneSubrangeCount = 0;
  ...
  uint64_t simInitialExactFrontierPerRequestShadowFirstMaxTieMismatches = 0;
  uint64_t simInitialExactFrontierPerRequestShadowSafeStoreDigestMismatches = 0;
  uint64_t simInitialExactFrontierPerRequestShadowTotalMismatches = 0;
  ...
  simInitialSafeStoreGpuPrecombinePruneShadowStats =
    getSimInitialSafeStoreGpuPrecombinePruneShadowStats();
  simInitialSafeStoreGpuPrecombinePruneStats =
    getSimInitialSafeStoreGpuPrecombinePruneStats();
  ...
  getSimInitialContextApplyChunkSkipStats(simInitialContextApplyChunkTotal,
	  ...
	  getSimInitialExactFrontierOneChunkBoundedShadowStats(
	    ...
	    simInitialExactFrontierOneChunkBoundedShadowRangeStartMin,
	    simInitialExactFrontierOneChunkBoundedShadowRangeStartMax,
	    simInitialExactFrontierOneChunkBoundedShadowRangeLengthMax,
	    simInitialExactFrontierOneChunkBoundedShadowStandaloneSubrangeCount,
	  ...
	  getSimInitialExactFrontierPerRequestShadowStats(
	    ...
	    simInitialExactFrontierPerRequestShadowSafeStoreDigestMismatches,
	    simInitialExactFrontierPerRequestShadowTotalMismatches);
  ...
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_requested_max_summaries="
      <<simCudaInitialExactFrontierOneChunkBoundedShadowRequestedMaxSummariesRuntime()<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_effective_max_summaries="
      <<simCudaInitialExactFrontierOneChunkBoundedShadowMaxSummariesRuntime()<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_hard_cap_summaries="
      <<simCudaInitialExactFrontierOneChunkBoundedShadowHardCapSummariesRuntime()<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_cap_clamped="
  ...
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_range_mode="
      <<simCudaInitialExactFrontierOneChunkBoundedShadowRangeModeName(
          simCudaInitialExactFrontierOneChunkBoundedShadowRangeModeRuntime())<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_range_start_min="
      <<simInitialExactFrontierOneChunkBoundedShadowRangeStartMin<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_range_start_max="
      <<simInitialExactFrontierOneChunkBoundedShadowRangeStartMax<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_range_length_max="
      <<simInitialExactFrontierOneChunkBoundedShadowRangeLengthMax<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_request_index="
      <<longtargetSimInitialExactFrontierOneChunkBoundedShadowRequestIndex()<<endl;
  ...
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_coverage_ratio_num="
      <<simInitialExactFrontierOneChunkBoundedShadowProcessedSummaries<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_coverage_ratio_den="
      <<simInitialExactFrontierOneChunkBoundedShadowInputSummaries<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_ranges_tested="
      <<simInitialExactFrontierOneChunkBoundedShadowCalls<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_one_chunk_bounded_shadow_standalone_subrange="
      <<(simInitialExactFrontierOneChunkBoundedShadowStandaloneSubrangeCount > 0 ? 1 : 0)<<endl;
  ...
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_requested="
      <<(simCudaInitialExactFrontierPerRequestShadowRequestedRuntime() ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_active="
  ...
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_requests_mismatched="
      <<simInitialExactFrontierPerRequestShadowRequestsMismatched<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_processed_summaries="
      <<simInitialExactFrontierPerRequestShadowProcessedSummaries<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_h2d_bytes="
      <<simInitialExactFrontierPerRequestShadowH2DBytes<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_d2h_bytes="
  ...
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_candidate_value_mismatches="
      <<simInitialExactFrontierPerRequestShadowCandidateValueMismatches<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_min_candidate_mismatches="
      <<simInitialExactFrontierPerRequestShadowMinCandidateMismatches<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_first_max_tie_mismatches="
      <<simInitialExactFrontierPerRequestShadowFirstMaxTieMismatches<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_safe_store_digest_mismatches="
      <<simInitialExactFrontierPerRequestShadowSafeStoreDigestMismatches<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_total_mismatches="
      <<simInitialExactFrontierPerRequestShadowTotalMismatches<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_has_candidate_contract=1"<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_has_safe_store_contract=1"<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_has_epoch_contract=0"<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_contract_level=candidate_safe_store"<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_contract_candidate_supported=1"<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_contract_safe_store_supported=1"<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_contract_epoch_supported=0"<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_full_contract_supported=0"<<endl;
  cerr<<"benchmark.sim_initial_exact_frontier_per_request_shadow_full_contract_disabled_reason=missing_epoch_contract"<<endl;
  ...
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_enabled="
      <<(simCudaInitialSafeStoreGpuPrecombineShadowEnabledRuntime() ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_calls="
      <<simInitialSafeStoreGpuPrecombineShadowStats.calls<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_seconds="
      <<(static_cast<double>(simInitialSafeStoreGpuPrecombineShadowStats.nanoseconds) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_input_summaries="
      <<simInitialSafeStoreGpuPrecombineShadowStats.inputSummaries<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_unique_states="
      <<simInitialSafeStoreGpuPrecombineShadowStats.uniqueStates<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_est_saved_upserts="
      <<simInitialSafeStoreGpuPrecombineShadowStats.estSavedUpserts<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_h2d_bytes="
      <<simInitialSafeStoreGpuPrecombineShadowStats.h2dBytes<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_d2h_bytes="
      <<simInitialSafeStoreGpuPrecombineShadowStats.d2hBytes<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_size_mismatches="
      <<simInitialSafeStoreGpuPrecombineShadowStats.sizeMismatches<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_candidate_mismatches="
      <<simInitialSafeStoreGpuPrecombineShadowStats.candidateMismatches<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_shadow_order_mismatches="
  ...
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_enabled="
      <<(simCudaInitialSafeStoreGpuPrecombinePruneShadowEnabledRuntime() ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_calls="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.calls<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_seconds="
      <<(static_cast<double>(simInitialSafeStoreGpuPrecombinePruneShadowStats.nanoseconds) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_input_states="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.inputStates<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_kept_states="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.keptStates<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_removed_states="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.removedStates<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_removed_ratio="
      <<(simInitialSafeStoreGpuPrecombinePruneShadowStats.inputStates == 0
           ? 0.0
           : static_cast<double>(simInitialSafeStoreGpuPrecombinePruneShadowStats.removedStates) /
               static_cast<double>(simInitialSafeStoreGpuPrecombinePruneShadowStats.inputStates))<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_est_d2h_bytes_before="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.estD2HBytesBefore<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_est_d2h_bytes_after="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.estD2HBytesAfter<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_est_d2h_bytes_saved="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.estD2HBytesSaved<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_size_mismatches="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.sizeMismatches<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_candidate_mismatches="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.candidateMismatches<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_order_mismatches="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.orderMismatches<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_shadow_digest_mismatches="
      <<simInitialSafeStoreGpuPrecombinePruneShadowStats.digestMismatches<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_requested="
      <<(simCudaInitialSafeStoreGpuPrecombinePruneRequestedRuntime() ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_active="
      <<(simInitialSafeStoreGpuPrecombinePruneStats.active != 0 ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_validate_enabled="
      <<(simCudaInitialSafeStoreGpuPrecombinePruneValidateEnabledRuntime() ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_calls="
      <<simInitialSafeStoreGpuPrecombinePruneStats.calls<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_seconds="
      <<(static_cast<double>(simInitialSafeStoreGpuPrecombinePruneStats.nanoseconds) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_input_states="
      <<simInitialSafeStoreGpuPrecombinePruneStats.inputStates<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_kept_states="
      <<simInitialSafeStoreGpuPrecombinePruneStats.keptStates<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_removed_states="
      <<simInitialSafeStoreGpuPrecombinePruneStats.removedStates<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_removed_ratio="
      <<(simInitialSafeStoreGpuPrecombinePruneStats.inputStates == 0
           ? 0.0
           : static_cast<double>(simInitialSafeStoreGpuPrecombinePruneStats.removedStates) /
               static_cast<double>(simInitialSafeStoreGpuPrecombinePruneStats.inputStates))<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_d2h_bytes="
      <<simInitialSafeStoreGpuPrecombinePruneStats.d2hBytes<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_d2h_bytes_saved="
      <<simInitialSafeStoreGpuPrecombinePruneStats.d2hBytesSaved<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_validate_seconds="
      <<(static_cast<double>(simInitialSafeStoreGpuPrecombinePruneStats.validateNanoseconds) / 1.0e9)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_size_mismatches="
      <<simInitialSafeStoreGpuPrecombinePruneStats.sizeMismatches<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_candidate_mismatches="
      <<simInitialSafeStoreGpuPrecombinePruneStats.candidateMismatches<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_order_mismatches="
      <<simInitialSafeStoreGpuPrecombinePruneStats.orderMismatches<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_digest_mismatches="
  ...
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_packed_d2h_real_requested="
      <<(simCudaInitialSafeStoreGpuPrecombinePrunePackedD2HRealRequestedRuntime() ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_packed_d2h_real_active="
      <<(simInitialSafeStoreGpuPrecombinePruneStats.packedD2HRealActive != 0 ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_packed_d2h_validate_enabled="
      <<(simCudaInitialSafeStoreGpuPrecombinePrunePackedD2HValidateEnabledRuntime() ? 1 : 0)<<endl;
  cerr<<"benchmark.sim_initial_safe_store_gpu_precombine_prune_unpacked_d2h_bytes_elided="
