...
static inline void printLongTargetBenchmarkMetrics(const LongTargetExecutionMetrics &metrics)
{
  ...
  double simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxHeapBuildSeconds = 0.0;
  ...
  double simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapBuildAccountingSeconds = 0.0;
  double simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapUpdateTraceRecordSeconds = 0.0;
  double simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualStartIndexRebuildTraceRecordSeconds = 0.0;
  double simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualResidualSeconds = 0.0;
  ...
  uint64_t simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapBuildAccountingCount = 0;
  uint64_t simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapUpdateTraceRecordCount = 0;
  uint64_t simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualStartIndexRebuildTraceRecordCount = 0;
  ...
  getSimInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxTimingStats(
    simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxHeapBuildSeconds,
  ...
  getSimInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualTimingStats(
    simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapBuildAccountingSeconds,
    simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapUpdateTraceRecordSeconds,
    simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualStartIndexRebuildTraceRecordSeconds,
    simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualResidualSeconds);
  ...
  getSimInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxCountStats(
  ...
  getSimInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualCountStats(
    simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapBuildAccountingCount,
    simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapUpdateTraceRecordCount,
    simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualStartIndexRebuildTraceRecordCount);
  ...
  const SimDeviceOrderedMaintenanceShadowValidationSnapshot
    simDeviceOrderedMaintenanceShadowSnapshot =
  ...
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_heap_build_seconds="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxHeapBuildSeconds<<endl;
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_heap_update_seconds="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxHeapUpdateSeconds<<endl;
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_start_index_rebuild_seconds="
  ...
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_other_residual_heap_build_accounting_seconds="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapBuildAccountingSeconds<<endl;
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_other_residual_heap_update_trace_record_seconds="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapUpdateTraceRecordSeconds<<endl;
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_other_residual_start_index_rebuild_trace_record_seconds="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualStartIndexRebuildTraceRecordSeconds<<endl;
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_other_residual_residual_seconds="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualResidualSeconds<<endl;
  ...
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_heap_build_count="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxHeapBuildCount<<endl;
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_heap_update_count="
  ...
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_other_residual_heap_build_accounting_count="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapBuildAccountingCount<<endl;
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_other_residual_heap_update_trace_record_count="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualHeapUpdateTraceRecordCount<<endl;
  cerr<<"benchmark.sim_initial_store_other_merge_context_apply_lookup_miss_reuse_writeback_aux_other_residual_start_index_rebuild_trace_record_count="
      <<simInitialStoreOtherMergeContextApplyLookupMissReuseWritebackAuxOtherResidualStartIndexRebuildTraceRecordCount<<endl;
  ...
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_enabled="
  ...
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_summary_count="
      <<simDeviceOrderedMaintenanceShadowSnapshot.shadowSummaryCount<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_event_count="
      <<simDeviceOrderedMaintenanceShadowSnapshot.shadowEventCount<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_mismatch_count="
      <<simDeviceOrderedMaintenanceShadowSnapshot.shadowMismatchCount<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_seconds="
      <<simDeviceOrderedMaintenanceShadowSnapshot.shadowSeconds<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_host_cpu_merge_seconds="
      <<simDeviceOrderedMaintenanceShadowSnapshot.hostCpuMergeSeconds<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_host_final_candidate_state_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.hostFinalCandidateStateHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_final_candidate_state_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.shadowFinalCandidateStateHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_host_replacement_sequence_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.hostReplacementSequenceHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_replacement_sequence_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.shadowReplacementSequenceHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_host_running_min_update_sequence_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.hostRunningMinUpdateSequenceHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_running_min_update_sequence_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.shadowRunningMinUpdateSequenceHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_host_candidate_index_visibility_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.hostCandidateIndexVisibilityHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_candidate_index_visibility_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.shadowCandidateIndexVisibilityHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_host_safe_store_state_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.hostSafeStoreStateHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_shadow_safe_store_state_hash="
      <<simDeviceOrderedMaintenanceShadowSnapshot.shadowSafeStoreStateHash<<endl;
  cerr<<"benchmark.sim_device_ordered_maintenance_host_observed_candidate_index_hash="
