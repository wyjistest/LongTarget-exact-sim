                                                                ...
                                                                vector<double> &taskFilterSeconds)
{
  ...
  if(benchmarkEnabled)
  {
    ...
    recordSimInitialSummaryHostCopyElision(
      ...
      preparedBatch.cudaBatchResult.initialSummaryHostCopyElisionBaseCopyReuses,
      preparedBatch.cudaBatchResult.initialSummaryHostCopyElisionRunCountCopySkips,
      preparedBatch.cudaBatchResult.initialSummaryHostCopyElisionEventCountCopySkips);
    recordSimInitialTrueBatchSingleRequestPrefixSkips(
      preparedBatch.cudaBatchResult.initialTrueBatchSingleRequestPrefixSkips);
    recordSimInitialTrueBatchSingleRequestInputPackSkips(
      preparedBatch.cudaBatchResult.initialTrueBatchSingleRequestInputPackSkips);
    ...
    recordSimInitialTrueBatchSingleRequestEventScoreFloorUploadSkips(
      preparedBatch.cudaBatchResult.initialTrueBatchSingleRequestEventScoreFloorUploadSkips);
    ...
    recordSimInitialProposalOnlineZeroCandidateCountCopySkips(
      preparedBatch.cudaBatchResult.initialProposalOnlineZeroCandidateCountCopySkips);
    ...
    recordSimInitialTrueBatchSingleRequestProposalV3StateCountUploadSkips(
      preparedBatch.cudaBatchResult.initialTrueBatchSingleRequestProposalV3StateCountUploadSkips);
    recordSimInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkips(
      preparedBatch.cudaBatchResult.initialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkips);
    ...
    recordSimInitialTrueBatchSingleRequestProposalV3SelectedCompactSkips(
      preparedBatch.cudaBatchResult.initialTrueBatchSingleRequestProposalV3SelectedCompactSkips);
...
static inline void printLongTargetBenchmarkMetrics(const LongTargetExecutionMetrics &metrics)
{
  ...
  uint64_t simInitialSummaryHostCopyElisionBaseCopyReuses = 0;
  uint64_t simInitialSummaryHostCopyElisionRunCountCopySkips = 0;
  uint64_t simInitialSummaryHostCopyElisionEventCountCopySkips = 0;
  uint64_t simInitialTrueBatchSingleRequestPrefixSkips = 0;
  ...
  uint64_t simInitialProposalOnlineZeroCandidateCountCopySkips = 0;
  ...
  uint64_t simInitialTrueBatchSingleRequestProposalV3StateCountUploadSkips = 0;
  uint64_t simInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkips = 0;
  uint64_t simInitialTrueBatchSingleRequestProposalV3SelectedBaseUploadSkips = 0;
  uint64_t simInitialTrueBatchSingleRequestProposalV3SelectedCompactSkips = 0;
  ...
  getSimInitialSummaryHostCopyElisionStats(simInitialSummaryHostCopyElisionEnabledCount,
                                           ...
                                           simInitialSummaryHostCopyElisionBaseCopyReuses,
                                           simInitialSummaryHostCopyElisionRunCountCopySkips,
                                           simInitialSummaryHostCopyElisionEventCountCopySkips);
  getSimInitialTrueBatchSingleRequestPrefixStats(simInitialTrueBatchSingleRequestPrefixSkips);
  getSimInitialTrueBatchSingleRequestInputPackStats(simInitialTrueBatchSingleRequestInputPackSkips);
  getSimInitialTrueBatchSingleRequestTargetBufferStats(
  ...
  getSimInitialTrueBatchSingleRequestEventScoreFloorUploadStats(
    simInitialTrueBatchSingleRequestEventScoreFloorUploadSkips);
  getSimInitialTrueBatchSingleRequestCountCopyStats(simInitialTrueBatchSingleRequestCountCopySkips);
  getSimInitialTrueBatchSingleRequestRunBaseBufferEnsureStats(
  ...
  getSimInitialTrueBatchSingleRequestAllCandidateBasePrefixStats(
  ...
  getSimInitialProposalOnlineZeroCandidateCountCopyStats(
    simInitialProposalOnlineZeroCandidateCountCopySkips);
  ...
  getSimInitialTrueBatchSingleRequestProposalV3StateCountUploadStats(
    simInitialTrueBatchSingleRequestProposalV3StateCountUploadSkips);
  getSimInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureStats(
    simInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkips);
  ...
  getSimInitialTrueBatchSingleRequestProposalV3SelectedCompactStats(
    simInitialTrueBatchSingleRequestProposalV3SelectedCompactSkips);
  ...
  cerr<<"benchmark.sim_initial_summary_host_copy_elision_base_copy_reuses="
      <<simInitialSummaryHostCopyElisionBaseCopyReuses<<endl;
  cerr<<"benchmark.sim_initial_summary_host_copy_elision_run_count_copy_skips="
      <<simInitialSummaryHostCopyElisionRunCountCopySkips<<endl;
  cerr<<"benchmark.sim_initial_summary_host_copy_elision_event_count_copy_skips="
      <<simInitialSummaryHostCopyElisionEventCountCopySkips<<endl;
  cerr<<"benchmark.sim_initial_true_batch_single_request_prefix_skips="
      <<simInitialTrueBatchSingleRequestPrefixSkips<<endl;
  cerr<<"benchmark.sim_initial_true_batch_single_request_input_pack_skips="
      <<simInitialTrueBatchSingleRequestInputPackSkips<<endl;
  cerr<<"benchmark.sim_initial_true_batch_single_request_target_buffer_skips="
  ...
  cerr<<"benchmark.sim_initial_true_batch_single_request_event_score_floor_upload_skips="
      <<simInitialTrueBatchSingleRequestEventScoreFloorUploadSkips<<endl;
  cerr<<"benchmark.sim_initial_true_batch_single_request_count_copy_skips="
      <<simInitialTrueBatchSingleRequestCountCopySkips<<endl;
  cerr<<"benchmark.sim_initial_true_batch_single_request_run_base_buffer_ensure_skips="
  ...
  cerr<<"benchmark.sim_initial_true_batch_single_request_all_candidate_base_prefix_skips="
  ...
  cerr<<"benchmark.sim_initial_proposal_online_zero_candidate_count_copy_skips="
      <<simInitialProposalOnlineZeroCandidateCountCopySkips<<endl;
  ...
  cerr<<"benchmark.sim_initial_hash_reduce_single_request_base_buffer_ensure_skips="
  ...
  cerr<<"benchmark.sim_initial_true_batch_single_request_proposal_v3_state_count_upload_skips="
      <<simInitialTrueBatchSingleRequestProposalV3StateCountUploadSkips<<endl;
  cerr<<"benchmark.sim_initial_true_batch_single_request_proposal_v3_selected_buffer_ensure_skips="
      <<simInitialTrueBatchSingleRequestProposalV3SelectedBufferEnsureSkips<<endl;
  ...
  cerr<<"benchmark.sim_initial_true_batch_single_request_proposal_v3_selected_compact_skips="
      <<simInitialTrueBatchSingleRequestProposalV3SelectedCompactSkips<<endl;
  ...
  cerr<<"benchmark.sim_locate_gpu_seconds="<<simLocateGpuSeconds<<endl;
	  ...
	  cerr<<"benchmark.sim_region_packed_candidate_buffer_high_water_ensure_skips="
	      <<getSimRegionPackedCandidateBufferHighWaterEnsureSkipCount()<<endl;
