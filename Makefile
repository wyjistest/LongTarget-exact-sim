...
check-sim-initial-exact-frontier-per-request-shadow-smoke:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW=1 LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW_REQUEST_INDEX=47 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_smoke TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_smoke EXPECTED_SELECTION_MODE=request_index EXPECTED_REQUEST_INDEX=47 EXPECTED_MAX_REQUESTS=0 EXPECTED_REQUESTS_SELECTED=1 EXPECTED_REQUESTS_SKIPPED=47 EXPECTED_REQUESTS_COMPARED=1 sh ./scripts/check_per_request_shadow_telemetry.sh

check-sim-initial-exact-frontier-per-request-shadow-resident-smoke:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW=1 LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW_RESIDENT_SOURCE=1 LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW_REQUEST_INDEX=47 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_resident_smoke TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_resident_smoke EXPECTED_SELECTION_MODE=request_index EXPECTED_REQUEST_INDEX=47 EXPECTED_MAX_REQUESTS=0 EXPECTED_REQUESTS_SELECTED=1 EXPECTED_REQUESTS_SKIPPED=47 EXPECTED_REQUESTS_COMPARED=1 EXPECTED_RESIDENT_SOURCE_REQUESTED=1 EXPECTED_RESIDENT_SOURCE_ACTIVE=1 EXPECTED_RESIDENT_SOURCE_SUPPORTED=1 EXPECTED_RESIDENT_SOURCE_DISABLED_REASON=active EXPECTED_SUMMARY_H2D_ELIDED=1 EXPECTED_INPUT_SOURCE=device_resident EXPECTED_RESIDENT_SOURCE_FALLBACKS=0 sh ./scripts/check_per_request_shadow_telemetry.sh

check-sim-initial-exact-frontier-per-request-shadow-sampled:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW=1 LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW_REQUEST_LIST=0,24,47 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_sampled TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_sampled EXPECTED_SELECTION_MODE=request_list EXPECTED_REQUEST_INDEX=none EXPECTED_MAX_REQUESTS=0 EXPECTED_REQUESTS_SELECTED=3 EXPECTED_REQUESTS_SKIPPED=45 EXPECTED_REQUESTS_COMPARED=3 sh ./scripts/check_per_request_shadow_telemetry.sh

check-sim-initial-exact-frontier-per-request-shadow-resident-sampled:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW=1 LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW_RESIDENT_SOURCE=1 LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW_REQUEST_LIST=0,24,47 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_resident_sampled TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_resident_sampled EXPECTED_SELECTION_MODE=request_list EXPECTED_REQUEST_INDEX=none EXPECTED_MAX_REQUESTS=0 EXPECTED_REQUESTS_SELECTED=3 EXPECTED_REQUESTS_SKIPPED=45 EXPECTED_REQUESTS_COMPARED=3 EXPECTED_RESIDENT_SOURCE_REQUESTED=1 EXPECTED_RESIDENT_SOURCE_ACTIVE=1 EXPECTED_RESIDENT_SOURCE_SUPPORTED=1 EXPECTED_RESIDENT_SOURCE_DISABLED_REASON=active EXPECTED_SUMMARY_H2D_ELIDED=1 EXPECTED_INPUT_SOURCE=device_resident EXPECTED_RESIDENT_SOURCE_FALLBACKS=0 sh ./scripts/check_per_request_shadow_telemetry.sh

check-sim-initial-exact-frontier-per-request-shadow-invalid:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW=1 LONGTARGET_SIM_CUDA_INITIAL_EXACT_FRONTIER_PER_REQUEST_SHADOW_REQUEST_INDEX=999 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_invalid TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_per_request_shadow_invalid EXPECTED_ACTIVE=0 EXPECTED_DISABLED_REASON=invalid_selection EXPECTED_SELECTION_MODE=request_index EXPECTED_REQUEST_INDEX=999 EXPECTED_MAX_REQUESTS=0 EXPECTED_REQUESTS_SELECTED=0 EXPECTED_REQUESTS_SKIPPED=48 EXPECTED_REQUESTS_COMPARED=0 EXPECTED_SELECTION_INVALID=1 EXPECTED_SELECTION_DISABLED_REASON=request_index_out_of_range sh ./scripts/check_per_request_shadow_telemetry.sh

check-sim-initial-exact-frontier-per-request-shadow-full:
	$(MAKE) build-cuda
...
check-sim-initial-safe-store-gpu-precombine:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE=1 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine sh ./scripts/check_initial_safe_store_gpu_precombine.sh

check-sim-initial-safe-store-gpu-precombine-validate:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_VALIDATE=1 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_validate TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_validate EXPECTED_VALIDATE=1 sh ./scripts/check_initial_safe_store_gpu_precombine.sh

check-sim-initial-safe-store-gpu-precombine-resident:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_RESIDENT_SOURCE=1 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_resident TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_resident EXPECTED_INPUT_SOURCE=device_resident EXPECTED_H2D_BYTES=0 EXPECTED_RESIDENT_REQUESTED=1 EXPECTED_RESIDENT_ACTIVE=1 EXPECTED_RESIDENT_SUPPORTED=1 EXPECTED_RESIDENT_DISABLED_REASON=active EXPECTED_SUMMARY_H2D_ELIDED=1 EXPECTED_SUMMARY_H2D_BYTES_SAVED=1432865216 sh ./scripts/check_initial_safe_store_gpu_precombine.sh

check-sim-initial-safe-store-gpu-precombine-prune-shadow:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_RESIDENT_SOURCE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE_SHADOW=1 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_shadow TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_shadow sh ./scripts/check_initial_safe_store_gpu_precombine_prune_shadow.sh

check-sim-initial-safe-store-gpu-precombine-prune:
	$(MAKE) build-cuda
...
check-sim-initial-safe-store-gpu-precombine-prune-fast-materialize:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_RESIDENT_SOURCE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE_FAST_MATERIALIZE=1 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_fast_materialize TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_fast_materialize sh ./scripts/check_initial_safe_store_gpu_precombine_prune_fast_materialize.sh

check-sim-initial-safe-store-gpu-precombine-prune-fast-materialize-validate:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_RESIDENT_SOURCE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE_FAST_MATERIALIZE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE_FAST_MATERIALIZE_VALIDATE=1 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_fast_materialize_validate TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_fast_materialize_validate EXPECTED_VALIDATE=1 sh ./scripts/check_initial_safe_store_gpu_precombine_prune_fast_materialize.sh
...
check-sim-initial-safe-store-gpu-precombine-prune-packed-d2h-real:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_RESIDENT_SOURCE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE_PACKED_D2H_REAL=1 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_packed_d2h_real TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_packed_d2h_real sh ./scripts/check_initial_safe_store_gpu_precombine_prune_packed_d2h_real.sh

check-sim-initial-safe-store-gpu-precombine-prune-packed-d2h-real-validate:
	$(MAKE) build-cuda
	LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_RESIDENT_SOURCE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE_PACKED_D2H_REAL=1 LONGTARGET_SIM_CUDA_INITIAL_SAFE_STORE_GPU_PRECOMBINE_PRUNE_PACKED_D2H_VALIDATE=1 LONGTARGET_ENABLE_SIM_CUDA=1 LONGTARGET_ENABLE_SIM_CUDA_REGION=1 LONGTARGET_ENABLE_SIM_CUDA_LOCATE=1 EXPECTED_SIM_INITIAL_BACKEND=cuda EXPECTED_SIM_REGION_BACKEND=cuda EXPECTED_SIM_LOCATE_MODE=safe_workset OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_packed_d2h_real_validate TARGET=$(CURDIR)/$(CUDA_TARGET) ./scripts/run_sample_exactness_cuda.sh
	OUTPUT_SUBDIR=sample_exactness_cuda_sim_region_locate_gpu_precombine_prune_packed_d2h_real_validate EXPECTED_VALIDATE=1 sh ./scripts/check_initial_safe_store_gpu_precombine_prune_packed_d2h_real.sh
...
SIM_INITIAL_EXACT_FRONTIER_ONE_CHUNK_TINY_CUDA_TEST_TARGET ?= tests/test_sim_initial_exact_frontier_one_chunk_tiny_cuda
SIM_INITIAL_EXACT_FRONTIER_ONE_CHUNK_TINY_CUDA_TEST_SOURCES := tests/test_sim_initial_exact_frontier_one_chunk_tiny_cuda.cpp cuda/sim_scan_cuda.o cuda/sim_traceback_cuda_stub.cpp cuda/sim_locate_cuda_stub.cpp
...
build-sim-initial-exact-frontier-one-chunk-tiny-cuda-test: $(SIM_INITIAL_EXACT_FRONTIER_ONE_CHUNK_TINY_CUDA_TEST_TARGET)
...
$(SIM_INITIAL_EXACT_FRONTIER_ONE_CHUNK_TINY_CUDA_TEST_TARGET): $(SIM_INITIAL_EXACT_FRONTIER_ONE_CHUNK_TINY_CUDA_TEST_SOURCES) sim.h cuda/sim_scan_cuda.h cuda/sim_cuda_runtime.h cuda/sim_traceback_cuda.h stats.h rules.h
	$(CXX) $(CPPFLAGS) -I$(CUDA_HOME)/include $(CXXFLAGS) $(ARCH_FLAGS) $(SIMD_FLAGS) $(PTHREAD_FLAGS) $(SIM_INITIAL_EXACT_FRONTIER_ONE_CHUNK_TINY_CUDA_TEST_SOURCES) $(LDFLAGS) $(LDLIBS) $(CUDA_LDFLAGS) -o $@
...
check-sim-initial-exact-frontier-one-chunk-tiny-cuda: $(SIM_INITIAL_EXACT_FRONTIER_ONE_CHUNK_TINY_CUDA_TEST_TARGET)
	./$(SIM_INITIAL_EXACT_FRONTIER_ONE_CHUNK_TINY_CUDA_TEST_TARGET)
