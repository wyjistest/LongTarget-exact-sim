...
check-fasim-sharded-manifest-threadsafe:
	PYTHONPATH=./scripts python3 ./scripts/check_fasim_sharded_manifest_threadsafe.py
...
check-fasim-forward-score-batch-shadow-characterization-parser:
	PYTHONPATH=./scripts python3 ./scripts/check_fasim_forward_score_batch_shadow_characterization_parser.py

check-fasim-score-bridge-characterization-parser:
	PYTHONPATH=./scripts python3 ./scripts/check_fasim_score_bridge_characterization_parser.py

check-fasim-shard-coalescing-characterization-parser:
	PYTHONPATH=./scripts python3 ./scripts/check_fasim_shard_coalescing_characterization_parser.py

check-fasim-group-target-records-option-characterization-parser:
	PYTHONPATH=./scripts python3 ./scripts/check_fasim_group_target_records_option_characterization_parser.py

check-fasim-prealign-cuda-fallback-taxonomy-parser:
	PYTHONPATH=./scripts python3 ./scripts/check_fasim_prealign_cuda_fallback_taxonomy_parser.py

check-fasim-prealign-cuda-resource-fit-parser:
	PYTHONPATH=./scripts python3 ./scripts/check_fasim_prealign_cuda_resource_fit_parser.py

check-fasim-current-base-prealign-telemetry:
	BIN=$(CURDIR)/fasim_longtarget_cuda bash ./scripts/check_fasim_current_base_prealign_telemetry.sh

check-fasim-align-profile-reuse-shadow:
	BIN=$(CURDIR)/fasim_longtarget_cuda bash ./scripts/check_fasim_align_profile_reuse_shadow.sh

check-fasim-align-profile-cache:
	BIN=$(CURDIR)/fasim_longtarget_cuda bash ./scripts/check_fasim_align_profile_cache.sh

check-fasim-forward-score-gpu-shadow:
	BIN=$(CURDIR)/fasim_longtarget_cuda bash ./scripts/check_fasim_forward_score_gpu_shadow.sh

check-fasim-forward-score-gpu-batch-shadow:
	BIN=$(CURDIR)/fasim_longtarget_cuda bash ./scripts/check_fasim_forward_score_gpu_batch_shadow.sh

check-fasim-score-bridge-shadow:
	BIN=$(CURDIR)/fasim_longtarget_cuda bash ./scripts/check_fasim_score_bridge_shadow.sh

check-fasim-sharded-runner-telemetry:
	BIN=$(CURDIR)/fasim_longtarget_cuda bash ./scripts/check_fasim_sharded_runner_telemetry.sh
